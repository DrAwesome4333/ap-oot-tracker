...
let RAW_LOCATION_DATA = {
    ...
    "10 Skulltulas Reward Hint": {
        "type": "Hint",
        "categories": null
    },
    "20 Skulltulas Reward Hint": {
        "type": "Hint",
        "categories": null
    },
    "30 Skulltulas Reward Hint": {
        "type": "Hint",
        "categories": null
    },
    "40 Skulltulas Reward Hint": {
        "type": "Hint",
        "categories": null
    },
    "50 Skulltulas Reward Hint": {
        "type": "Hint",
        "categories": null
    },
    "Ganondorf Hint": {
 ...
 */
const LOCATION_DATA = {}
for(let key of Object.getOwnPropertyNames(RAW_LOCATION_DATA)){
    let location = RAW_LOCATION_DATA[key];
    let categorySet = new Set();
    if(location['categories'] && typeof location['categories'] != 'string'){
        for(let i = 0; i < location['categories'].length; i++){
            categorySet.add(location['categories'][i]);
        }
    }else if(typeof location['categories'] === 'string'){
        categorySet.add(location['categories']);
    }
    LOCATION_DATA[key] = {
...
export {LOCATION_DATA, REGION_CATEGORIES, OVERWORLD_SCENE_CATEGORIES, DUNGEON_CATEGORIES}